(() => {
    ...
    function countdown(numberHours) {
        const oneHours = 3600;
        let seconds = numberHours * oneHours;
        const timer = setInterval((function() {
            ...
            let display = hours + ":" + minutes + ":" + remainingSeconds;
    ...
    countdown(2);
    const script_element = document.querySelector(".form__tel");
    const maskOptions = {
